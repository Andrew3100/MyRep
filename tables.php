...
/*выключаем отладку*/
debug();
/*Создать функция получения гет-параметра для любых идентификаторов*/
/*Создать функция получения гет-параметра для любых идентификаторов*/
/*Создать функция получения гет-параметра для любых идентификаторов*/
/*Создать функция получения гет-параметра для любых идентификаторов*/
/*Создать функция получения гет-параметра для любых идентификаторов*/
...
if ($_GET['add']) {
    $count_id = str_split($_GET['add']);
    $count_id = count($count_id);
}
if ($_GET['red']) {
    $count_id = str_split($_GET['red']);
    $count_id = count($count_id);
}
if ($_GET['upd']) {
    $count_id = str_split($_GET['upd']);
    $count_id = count($count_id);
}
$count_id = $count_id-1;
